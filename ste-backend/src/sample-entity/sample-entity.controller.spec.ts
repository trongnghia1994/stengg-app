...
describe('SampleEntitiesController', () => {
  ...
  beforeEach(async () => {
    ...
    sampleEntitiesController = moduleRef.get<SampleEntitiesController>(SampleEntitiesController);
  });
  ...
  describe('findAllPaginated', () => {
    it('should return a paginated result of sample entities', async () => {
      expect(await sampleEntitiesController.findAllPaginated(1, 10, undefined)).toBe(sampleEntitiesRes);
    });
  });
});
